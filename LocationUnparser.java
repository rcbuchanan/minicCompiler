...
public class LocationUnparser extends AstVisitor<String>
{
   ...
   */
	...
	if (exprResult != null) {
	    return  typeResult + " " + name + " = " + exprResult +
                    "; /*" + globalVar.getVariableSymbol().getType().getSize() + "*/\n";
	}
	else {
	...
	return  typeResult + " " + formalArg.getName() + "/*" +
                formalArg.getVariableSymbol().getType().getSize() + "*/";
    }
	...
	if (initResult != null) {
	    return  typeResult + " " + name + " = " + initResult +
                    "; /*" + localVar.getVariableSymbol().getType().getSize() + "*/\n";
	}
	else {
	    return  typeResult + " " + name +
                    "; /*" + localVar.getVariableSymbol().getType().getSize() + "*/\n";
	...
	return  "read " + readStmt.getDestinationName() + "/*" +
                readStmt.getVariableSymbol().getDeclarationLocation().getRow() + ":" +
                readStmt.getVariableSymbol().getDeclarationLocation().getCol() + ":" +
                ( (readStmt.getVariableSymbol() instanceof GlobalVariableSymbol) ? "G" : "L" ) + "*/;\n";
    }
	...
	// fcallExp
	return  fcallExp.getName() + "/*" +
                fcallExp.getFunctionSymbol().getDeclarationLocation().getRow() + ":" +
                fcallExp.getFunctionSymbol().getDeclarationLocation().getCol() +
                "*/(" + join(argResults, ", ") + ")";
    }
	...
	return  varRefExp.getName() + "/*" +
                varRefExp.getVariableSymbol().getDeclarationLocation().getRow() + ":" +
                varRefExp.getVariableSymbol().getDeclarationLocation().getCol() + ":" +
                ( (varRefExp.getVariableSymbol() instanceof GlobalVariableSymbol) ? "G" : "L" ) + "*/";
    }
